    ...
    return (
        ...
        <div className=" ">
            <button onClick={toggleMenu}>
                {
                    openMenu ?
                        <div className='bg-green-400 rounded-full w-16 h-16 fixed ml-10 mt-5 left-[5px] bottom-[35px] max-lg:left-0 max-lg:ml-5 max-lg:z-10'>
                            <img
                        ...
                        :
                        <div className='fixed ml-10 mt-5 left-[5px] bottom-[35px] z-10  max-lg:left-0 max-lg:ml-5'>
