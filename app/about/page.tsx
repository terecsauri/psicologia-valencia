        ...
        <div key={id} className='ml-10 mt-10'>
          ...
          <div className='grid grid-cols-3 '>
            ...
            <Image
              ...
              />
              <button className='bg-yellow-500 rounded w-72 flex font-bold p-1 bold mt-2'>{mediaText3}</button>
            ...
            <Image
              ...
              />
              <button className='bg-yellow-500 rounded w-72 flex font-bold p-1 bold mt-2'>{mediaText}</button>           
            </div>
            <div  className='p-3 bg-white border border-gray-200 w-1/2 shadow dark:bg-gray-800 dark:border-gray-700 justify-center'>
            <Image
              src={'https://' + media3.fields.file.url} alt="asdf" width={350} height={180}
              />
              <button className='bg-yellow-500 flex rounded w-72 font-bold p-1 bold mt-2'>{mediaText2}</button>       
            </div>
          </div>
          <AutorMain />
        </div>
