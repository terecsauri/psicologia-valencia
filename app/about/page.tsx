        ...
        <div className="grid grid-cols-3 ">
          <div className="p-3 bg-white border border-gray-200 w-1/2 shadow dark:bg-gray-800 dark:border-gray-700 justify-center">
            <img
              ...
              height="180"
            />
            <button className="bg-yellow-500 rounded flex font-bold p-1 bold mt-2">
              {mediaText3}
            </button>
          </div>
          <div className="p-3 bg-white border border-gray-200 w-1/2 shadow dark:bg-gray-800 dark:border-gray-700 justify-center">
            <img
              ...
              height="180"
            />
            <button className="bg-yellow-500 rounded w-40 flex font-bold p-1 bold mt-2">
              {mediaText}
            </button>
          </div>
          <div className="p-3 bg-white border border-gray-200 w-1/2 shadow dark:bg-gray-800 dark:border-gray-700 justify-center">
            <img
              ...
              height="180"
            />
            <button className="bg-yellow-500 flex rounded w-40 font-bold p-1 bold mt-2">
              {mediaText2}
            </button>
          </div>
        </div>
