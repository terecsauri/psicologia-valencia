    ...
    landingFooter?.map((singlePost: any) => {
      ...
      return (
        <div key={""} className="ml-10 mt-5">
          <div className='grid grid-cols-3 relative max-xl:block'>
            ...
            <div className='relative'>
              ...
              />
              <div className='font-extrabold absolute text-white text-2xl bottom-0 m-5 max-lg:text-sm' >{gridTitle2}</div>
            </div>
            <div className='relative'>
              <img
              ...
              />
              <div className='font-extrabold absolute text-white text-2xl bottom-0 m-5 max-lg:text-base' >{gridTitle3}</div>
            </div>
          </div>
